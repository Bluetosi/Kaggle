...
def initialize_parameters(n_x, n_y):
    ...
    W1 = tf.get_variable(name= "W1", shape= [n_x, 16], initializer= tf.contrib.layers.xavier_initializer(seed= 1))
    b1 = tf.get_variable(name= "b1", shape= [16], initializer= tf.zeros_initializer())
    W2 = tf.get_variable(name= "W2", shape= [16, 8], initializer= tf.contrib.layers.xavier_initializer(seed= 1))
    b2 = tf.get_variable(name= "b2", shape= [8], initializer= tf.zeros_initializer())
    W3 = tf.get_variable(name= "W3", shape= [8, n_y], initializer= tf.contrib.layers.xavier_initializer(seed= 1))
